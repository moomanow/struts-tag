...
@StrutsTag(name="setValueByString", tldBodyContent="JSP", tldTagClass="com.moomanow.web.struts.views.jsp.SetValueByStringTag", description="Assigns a value to a variable in a specified scope")
