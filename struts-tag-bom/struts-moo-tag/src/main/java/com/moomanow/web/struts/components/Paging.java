...
@StrutsTag(name="paging", tldBodyContent="JSP", tldTagClass="com.moomanow.web.struts.views.jsp.ui.PagingTag", description="Assigns a value to a variable in a specified scope")
