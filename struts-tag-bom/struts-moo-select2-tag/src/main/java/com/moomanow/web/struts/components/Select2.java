...
public class Select2 extends ListUIBean {
    final public static String TEMPLATE = "select2";
    ...
    public Select2(ValueStack stack, HttpServletRequest request, HttpServletResponse response) {
